...
namespace BUFFET.Migrations
{
    public partial class tabelas : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "UsuarioHoraAcesso",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    DataAcesso = table.Column<DateTime>(nullable: false),
                    UsuarioId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsuarioHoraAcesso", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UsuarioHoraAcesso_AspNetUsers_UsuarioId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsuarioHoraAcesso_UsuarioId",
                table: "UsuarioHoraAcesso",
                column: "UsuarioId");
        }
